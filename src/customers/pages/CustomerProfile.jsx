...
import { getCustomerProfileAPI, updateCustomerProfileAPI } from "../../services/allAPI";
...
export default function CustomerProfile() {
  ...
  const fetchProfile = async (rawToken) => {
    try {
      ...
      const response = await getCustomerProfileAPI(reqHeader);
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      const response = await updateCustomerProfileAPI(formDataToSend, reqHeader);
